...
const routerGenerator = (db) => {
    ...
    router.get('/sessionUserData', forceLogin, (req, res) => {
        const invitation_code = req.session.invitation_code
    ...
    router.get('/reviews', forceLogin, (req, res) => {
    ...
    router.get('/notices', forceLogin, (req, res) => {
        const user_id = req.session.user_id;
        const rows = db.prepare(`
    ...
    router.post('/writeReview', forceLogin, (req, res) => {
    ...
    router.get('/unlockReview', forceLogin, (req, res) => {
        const user_id = req.session.user_id
    ...
    router.get('/nowLovecoin', forceLogin, (req, res) => {
        const user_id = req.session.user_id
    ...
    router.post('/addLovecoin', forceLogin, (req, res) => {
        const user_id = req.session.user_id
    ...
    router.post('/writeMovieReview', forceLogin, (req, res) => {
        const user_id = req.session.user_id
    ...
    router.post('/rankDodgeAdd', forceLogin, (req, res) => {
        const user_id = req.session.user_id
    ...
    router.post('/rankGraphAdd', forceLogin, (req, res) => {
        const user_id = req.session.user_id
        const score = req.body.score
